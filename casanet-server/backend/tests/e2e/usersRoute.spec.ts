...
describe('Users routing API', () => {
  describe('/GET users/profile', () => {
    it('it should respond 20x as status code', done => {
      validAdminAgent.get('/API/users/profile').end((err, res) => {
  ...
  describe('/GET users', () => {
    it('it should respond 20x as status code', done => {
      validAdminAgent.get('/API/users').end((err, res) => {
        expect(res.statusType).eql(2);
        done();
      });
    });
    ...
    it('it should respond 40x as status code', done => {
      validUserAgent.get('/API/users').end((err, res) => {
  ...
  describe('/GET users/{userId}', () => {
    it('it should respond 20x as status code', done => {
      validAdminAgent.get('/API/users/user@casa.net').end((err, res) => {
        expect(res.statusType).eql(2);
        done();
      });
    });
    ...
    it('it should respond 20x as status code', done => {
      validUserAgent.get('/API/users/user@casa.net').end((err, res) => {
        expect(res.statusType).eql(2);
        done();
      });
    });
  ...
  describe('/POST users', () => {
    ...
    it('it should respond 500 as status code for short password', done => {
      validAdminAgent
        .post('/API/users')
  ...
  describe('/DELETE users/{userId}', () => {
    it('it should respond 20x as status code', done => {
      validAdminAgent.del(`/API/users/${newUser.email}`).end((err, res) => {
        expect(res.statusType).eql(2);
        done();
      });
    });
