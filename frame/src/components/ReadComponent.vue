...
<template>
    ...
    <a-scene vr-mode-ui="enabled: false;" renderer="logarithmicDepthBuffer: true; precision: medium;" embedded
        ...
        <a-marker type="pattern" url="../image/pattern-desk.patt" smooth="true" id="m1">
        ...
        <a-marker type="pattern"
            ...
            <a-entity collada-model="#tree-model" scale="0.5 0.5 0.5" position="0 0 0" rotation="0 0 0">
            </a-entity>
        ...
        <a-nft type="nft" videohandler url="https://raw.githack.com/AR-js-org/AR.js/master/data/dataNFT/pinball"
            ...
            <a-video src="#vid" position="0 0 0" width="300" height="400" rotation="-90 0 0" videoelement>
            </a-video>
